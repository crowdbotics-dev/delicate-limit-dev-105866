...
## Project Structure
    ...
    ├── delicate_limit_dev_105866  # Django project configurations
...
1. Clone this repo and `cd delicate_limit_dev_105866`
...
2. Clone this repo and `cd delicate_limit_dev_105866`
