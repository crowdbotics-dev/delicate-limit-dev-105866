"""
Django settings for delicate_limit_dev_105866 project.
...
ROOT_URLCONF = 'delicate_limit_dev_105866.urls'
...
WSGI_APPLICATION = 'delicate_limit_dev_105866.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "delicate_limit_dev_105866 API",
    "DESCRIPTION": "API documentation for delicate_limit_dev_105866 App",
    "VERSION": "v1",
}
